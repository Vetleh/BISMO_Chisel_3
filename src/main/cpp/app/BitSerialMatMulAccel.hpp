...
public:
    ...
    void set_signature(AccelReg value) { bismo_rocc_write(1, value); }

    // Stage enables
    void set_fetch_enable(AccelReg value) { bismo_rocc_write(2, value); }
    void set_exec_enable(AccelReg value) { bismo_rocc_write(3, value); }
    void set_result_enable(AccelReg value) { bismo_rocc_write(4, value); }
    ...
    // perf fetch
    AccelReg get_perf_prf_fetch_count() { return bismo_rocc_read(20); }
