...
class FetchInstructionGeneratorIn() extends Bundle {
  ...
  val lhs_bytes_per_l2 = UInt(32.W)
  val rhs_bytes_per_l2 = UInt(32.W)

  val dpa_z_bytes = UInt(16.W)
  val lhs_l0_per_l1 = UInt(16.W)
  val rhs_l0_per_l1 = UInt(16.W)
...
class FetchInstructionGenerator(
  ...
  // Counters
  val lhs_l2 = RegInit(UInt(16.W), 0.U)
  val rhs_l2 = RegInit(UInt(16.W), 0.U)
  val z_l2 = RegInit(UInt(16.W), 0.U)
  ...
  val current_bram_region = RegInit(UInt(2.W), 0.U)
